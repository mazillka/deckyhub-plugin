...
- Checks for DeckyHub stable releases or pre-releases from this repository and can install a validated DeckyHub release ZIP. Choose the update channel in Settings, then reload DeckyHub from the Decky menu after the update finishes.
