    ...
    <div className="steam-mock">
      <div className={`steam-deck${ActivePage ? " steam-deck-full" : ""}`}>
        <nav className="preview-nav" aria-label="Developer preview routes">
          ...
          <button className="preview-route" onClick={() => showDownloadComplete(previewText, previewText("appcard.downloadComplete"), "/home/deck/Downloads/deckyhub/DeckyHub-v1.0.2-rc.1.zip")}>
