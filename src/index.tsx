import { callable, definePlugin, fetchNoCors, routerHook, toaster } from "@decky/api";
...
function SettingsPage() {
  ...
  const [query, setQuery] = useState(""), [results, setResults] = useState<SearchRepo[]>([]), [searchError, setSearchError] = useState<string | null>(null);
  useEffect(() => { void getSettings().then(setSettings); void getDeckyHubInfo().then(setDeckyHubInfo); }, []);
