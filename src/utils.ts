...
export const pageStyle = { boxSizing: "border-box" as const, height: "calc(100% - 56px)", marginTop: "56px", overflowY: "auto" as const, padding: "8px 12px 96px", scrollPaddingBottom: 96, width: "100%" };
